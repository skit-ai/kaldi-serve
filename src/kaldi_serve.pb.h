...
inline bool RecognitionConfig::enable_word_time_offsets() const {
  // @@protoc_insertion_point(field_get:kaldi_serve.RecognitionConfig.enable_word_time_offsets)
...
inline void RecognitionConfig::set_enable_word_time_offsets(bool value) {
  ...
  // @@protoc_insertion_point(field_set:kaldi_serve.RecognitionConfig.enable_word_time_offsets)
}
