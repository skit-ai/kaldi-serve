...
public:
  ...
  shared_ptr<Decoder> operator()(kaldi::BaseFloat beam, std::size_t max_active,
                      std::size_t min_active, kaldi::BaseFloat lattice_beam,
                      kaldi::BaseFloat acoustic_scale, std::size_t frame_subsampling_factor,
    ...
    return shared_ptr<Decoder>(new Decoder(beam, max_active, min_active, lattice_beam,
...
public:
  explicit KaldiServeImpl(const shared_ptr<Decoder> &decoder): decoder(decoder) {}

  Status Recognize(grpc::ServerContext* context, 
...
int main(int argc, char* argv[]) {
  ...
  shared_ptr<Decoder> decoder = decoder_factory(13.0, 7000, 200, 6.0, 1.0, 3,
